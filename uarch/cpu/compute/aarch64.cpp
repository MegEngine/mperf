 ...
 * or implied.
 * ---------------------------------------------------------------------------
 * \file uarch/cpu/compute/aarch64.cpp
 *
...
void mperf::aarch64() {
    ...
    benchmark(mla_throughput, mla_latency, "mla(4s)", 8);
...
#if __ARM_FEATURE_DOTPROD
    benchmark(sdot_throughput, sdot_latency, "sdot",
              16);  // 32->16 TODO(hc): check the modify
#endif
    ...
    benchmark(tbl_throughput, tbl_latency, "tbl(8b)",
              8);  // 16->8 TODO(hc): check the modify
